...
class td_js {
    ...
    function td_js_licence_inactive_on_domain_admin_notice() {
        if ( $this->check_if_is_our_page() === true || !current_user_can( 'switch_themes' ) ) {
            return;
        }
    ...
    function td_js_msg_2() {
        if ($this->check_if_is_our_page() === true || td_api_features::is_enabled('require_activation') === false  || !current_user_can( 'switch_themes' ) ) {
            return;
        }
        $td_activate_url = 'https://forum.tagdiv.com/newspaper-6-how-to-activate-the-theme/';
