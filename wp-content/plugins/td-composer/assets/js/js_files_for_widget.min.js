...
k=b.find(".tdc-css-box-input-margin-left").val().trim(),n=b.find(".tdc-css-box-input-border-top-width").val().trim(),h=b.find(".tdc-css-box-input-border-right-width").val().trim(),m=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),l=b.find(".tdc-css-box-input-border-left-width").val().trim(),p=b.find(".tdc-css-box-input-padding-top").val().trim(),x=b.find(".tdc-css-box-input-padding-right").val().trim(),r=b.find(".tdc-css-box-input-padding-bottom").val().trim(),u=b.find(".tdc-css-box-input-padding-left").val().trim(),
w=b.find(".tdc-css-border-radius").val().trim(),z=b.find(".tdc-css-width").val().trim(),A=b.find(".tdc-css-height").val().trim(),B=b.find(".tdc-css-shadow-size").val().trim(),q=b.find(".tdc-css-shadow-offset-h").val().trim(),v=b.find(".tdc-css-shadow-offset-v").val().trim(),y=b.find(".tdc-css-opacity").val().trim(),C=b.find(".tdc-css-gradient-direction").val().trim(),E=b.find(".tdc-css-z-index").val().trim(),D="";b.find(".tdc-css-order").length&&(D=b.find(".tdc-css-order").val().trim());""!==d&&(c["margin-top"]=
d);""!==f&&(c["margin-right"]=f);""!==g&&(c["margin-bottom"]=g);""!==k&&(c["margin-left"]=k);""!==n&&(c["border-top-width"]=n);""!==h&&(c["border-right-width"]=h);""!==m&&(c["border-bottom-width"]=m);""!==l&&(c["border-left-width"]=l);""!==p&&(c["padding-top"]=p);""!==x&&(c["padding-right"]=x);""!==r&&(c["padding-bottom"]=r);""!==u&&(c["padding-left"]=u);d=b.find(".tdc-css-border-style");f=d.val().trim();""===f||d.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["border-style"]=
f);d=b.find(".tdc-css-border-color");f=d.val().trim();""!==f?c["border-color"]=f:(d=d.data("no_value"),a.isUndefined(d)||1!==d||(c["border-color"]="no_value"));""!==w&&(c["border-radius"]=w);""!==z&&(c.width=z);""!==A&&(c.height=A);""!==B&&(c["shadow-size"]=B);w=b.find(".tdc-css-shadow-color");z=w.val().trim();""!==z?c["shadow-color"]=z:(w=w.data("no_value"),a.isUndefined(w)||1!==w||(c["shadow-color"]="no_value"));""!==q&&(c["shadow-offset-h"]=q);""!==v&&(c["shadow-offset-v"]=v);q=b.find(".tdc-css-bg-color");
v=q.val().trim();""!==v?c["background-color"]=v:(q=q.data("no_value"),a.isUndefined(q)||1!==q||(c["background-color"]="no_value"));q=b.find(".tdc-css-bg-image");q.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(q=q.data("image_link"),a.isUndefined(q)||("no_value"===q?c["background-image"]="no_value":""!==q&&(c["background-image"]='url("'+q+'")')));q=b.find(".tdc-css-bg-style");v=q.val().trim();""===v||q.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||
(c["background-style"]=v);q=b.find(".tdc-css-bg-position");v=q.val().trim();""===v||q.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["background-position"]=v);""!==y&&(c.opacity=y);y=b.find(".tdc-css-color-1-overlay");q=y.val().trim();""!==q?c["color-1-overlay"]=q:(y=y.data("no_value"),a.isUndefined(y)||1!==y||(c["color-1-overlay"]="no_value"));y=b.find(".tdc-css-color-2-overlay");q=y.val().trim();""!==q?c["color-2-overlay"]=q:(y=y.data("no_value"),a.isUndefined(y)||
...
function(a){var b=jQuery(this),c=b.closest(".tdc-property-responsive"),d=c.find('input[type="range"]'),f=c.find('input[type="radio"]:checked'),g=c.find('input[type="text"]'),k=d.get(0),n="",h=f.data("default_value"),m=tdcIFrameData.getModel(d.data("model_id")),l=d.data("param_name"),p=window.tdcAdminSettings.mappedShortcodes[m.attributes.tag],x=m="";var r=[];for(var u=0;u<p.params.length;u++)if(l===p.params[u].param_name){u=p.params[u].tdc_values;for(var w in u)u.hasOwnProperty(w)&&(r.push(u[w].unit),
""===m||""===x)&&(m=u[w].value,x=u[w].unit);break}f.length&&(n=f.data("unit_value"));if("range"===b.attr("type"))r=d.val(),g.val(r),f.data("last_value",r),g.val(r),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+n,tdcSidebar.currentViewportSettings.name)),c.removeClass("tdc-css-inherited");else if("text"===b.attr("type")){if("input"===a.type||"change"===a.type)return;c.removeClass("tdc-css-inherited");r=g.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
...
!0),k.min=w,k.max=f,k.step=p,k.value=m,n.data("last_value",m),g.val(m));else if(""===r)if(n=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),"undefined"===typeof n)d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+l,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",x),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+x+'"]'),p=n.data("unit"),w=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",
!0),k.min=w,k.max=f,k.step=p,k.value=m,n.data("last_value",m),g.val(m),c.addClass("tdc-css-inherited");else for(u=0;u<p.params.length;u++){if(l===p.params[u].param_name){r=[];g=[];u=p.params[u].tdc_values;for(w in u)u.hasOwnProperty(w)&&r.push(u[w].unit);for(u=0;u<r.length&&!(g=n.split(r[u]),1<g.length);u++);g.length&&(m=g[0],x=r[u],d.data("range_value",m),d.data("range_unit",x),n=c.find('input[type="radio"][data-unit_value="'+x+'"]'),p=n.data("unit"),w=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+
p),n.prop("checked",!0),k.min=w,k.max=f,k.step=p,k.value=m,n.data("last_value",m),c.find('input[type="text"]').val(m));d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+l,tdcSidebar.currentViewportSettings.name));c.addClass("tdc-css-inherited");break}}else d.val(r),f.data("last_value",r),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+n,tdcSidebar.currentViewportSettings.name))}else if("radio"===b.attr("type")){if("input"===a.type)return;
l=f.data("last_value");p=f.data("unit");w=d.data("min_"+p);f=d.data("max_"+p);p=d.data("step_"+p);k.min=w;k.max=f;k.step=p;""===l?(g.val(h),d.val(h),r=h):(g.val(l),d.val(l),r=l);d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+n,tdcSidebar.currentViewportSettings.name));c.removeClass("tdc-css-inherited")}n="";c=jQuery(k).parent().find('input[type="radio"]:checked');c.length&&(n=jQuery(c[0]).data("unit_value"));"focusin"===a.type?k.oldValue=k.value+n:(c=jQuery(k),
...
for(var g=0;g<f.length;g++){var k=!1,n=f[g];if(0===n.param_name.indexOf("tds_")){for(var h in d)if(n.param_name===h){c[h]=d[h];k=!0;break}k||(c[n.param_name]="")}}for(h in d)switch(d=h.split("-"),d.length){case 2:if(!_.has(c,h)){f=d[0];d=!1;for(var m in c)if(f===c[m]&&1===m.split("-").length){d=!0;break}if(!d){var t;for(t in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[t],f)){var p=t;break}_.has(c,p)&&""===c[p]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=
!0)}d||delete e[h]}break;case 3:f=d[0];k=d[2];for(t in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[t],f)){p=t;break}d=!1;for(m in c)if(f===c[m]&&m===p+"-"+k){d=!0;break}d||_.has(c,p+"-"+k)&&""===c[p+"-"+k]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0);d||delete e[h]}var x=[],r;for(r in window.tdcAdminSettings.listStyles[b])if(r===a){for(g=0;g<window.tdcAdminSettings.listStyles[b][r].length;g++)h=window.tdcAdminSettings.listStyles[b][r][g],_.isArray(h)?
...
(n='data-disable-params="'+a.toggle_disable_params+'"');var h="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');var m="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(m='data-enabled-by="'+a.toggle_enabled_by+'"');var l="";_.has(a,"toggle_disabled_by")&&""!==a.toggle_disabled_by&&(l='data-disabled-by="'+a.toggle_disabled_by+'"');var p=d="",x=!1,r=Object.keys(a.value),u=!0;if(_.has(a,"tdc_min_options")&&r.length<=parseInt(a.tdc_min_options))return d;
for(var w=0;w<r.length;w++){var z=!1,A="",B="",q="",v="",y="",C=r[w],E=String(tdcSidebarPanel._getParameterCurrentValue(a,c)),D=String(a.value[r[w]]);_.has(a,"options_to_disable")&&""!==a.options_to_disable&&(B=a.options_to_disable);_.has(a,"options_to_hide")&&""!==a.options_to_hide&&(q=a.options_to_hide);_.isObject(a.value[r[w]])&&(z=!0,D=_.values(a.value[r[w]])[0],C=_.keys(a.value[r[w]])[0]);if(f||g)0===w&&""===E&&(E=D),E===D&&(A=" checked "),B=_.uniqueId(),q=D,"vc_row"!==c.attributes.tag&&"vc_row_inner"!==
c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(q="col_"+q),p+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+B+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+A+' value="'+D+'">',f?(A="",z&&(A="tdc-standard-value"),p+='<label class="tdc-property-input-radio-label '+A+'" for="'+B+'" title="'+C+'"><div class="'+q+'"></div></label>'):p+='<label class="tdc-property-input-radio-label" for="'+B+'" title="'+C+'">'+D+"</label>";else{E===
D&&(A=' selected="selected" ',u=!1);if("__"===D&&-1!==C.search("--")||-1<B.indexOf(D)&&""!==D)v=" disabled ";-1<q.indexOf(D)&&""!==D&&(y=' style="display:none" ',"popular"===D&&(y=""));""!==v&&""!==A&&(x=!0);p+="<option "+A+" "+v+y+' value="'+D+'">'+C+"</option>"}}r="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':r=' title="'+a.description+'" ');d+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+k+" "+n+" "+h+" "+m+" "+l+">";d+=
'<div class="tdc-property-title"><span class="tdc-search-data"'+r+">"+a.heading+"</span>";b="";e="#";"tdb_flex_block_builder"!==c.get("tag")&&"tdb_flex_loop_builder"!==c.get("tag")||"cloud_tpl_module_id"!==a.param_name||(b="tdc-edit-cloud_tpl_module_id",k='style="margin-left: 10px"',_.has(c.get("attrs"),"cloud_tpl_module_id")?""===c.get("attrs").cloud_tpl_module_id.trim()?k='style="margin-left: 10px; display: none"':"undefined"!==typeof window.tdData&&(e=tdData.adminUrl+"post.php?post_id="+c.get("attrs").cloud_tpl_module_id.trim()+
...
!0===a.responsive_disable_default&&(h=' data-responsive-disable-default="1"');var m="",l="",p=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&p.length<=parseInt(a.tdc_min_options))return m;var x=' data-responsive="" ',r=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var u=JSON.parse(window.atob(r));x=' data-responsive="'+r+'" ';"undefined"!==typeof u[tdcSidebar.currentViewportSettings.name]&&(r=u[tdcSidebar.currentViewportSettings.name])}catch(y){}for(u=0;u<p.length;u++){var w=!1,
z="",A="",B=p[u],q=String(a.value[p[u]]);_.isObject(a.value[p[u]])&&(w=!0,q=_.values(a.value[p[u]])[0],B=_.keys(a.value[p[u]])[0]);if(d||f){0===u&&""===r&&(r=q);r===q&&(z=" checked ");A=_.uniqueId();var v=q;"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(v="col_"+v);l+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+A+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+z+' value="'+q+
'" '+x+">";d?(z="",w&&(z="tdc-standard-value"),l+='<label class="tdc-property-input-radio-label '+z+'" for="'+A+'" title="'+B+'"><div class="'+v+'"></div></label>'):l+='<label class="tdc-property-input-radio-label" for="'+A+'" title="'+B+'">'+q+"</label>"}else r===q&&(z=' selected="selected" '),"__"===q.substring(0,2)&&-1!==B.search("--")&&(A=" disabled "),l+="<option "+z+" "+A+' value="'+q+'">'+B+"</option>"}p="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+
...
var p="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(p='data-enabled-by="'+a.toggle_enabled_by+'"');var x=' data-responsive="" ',r=tdcSidebarPanel._getParameterCurrentValue(a,c);try{var u=JSON.parse(window.atob(r));x=' data-responsive="'+r+'" ';r="undefined"===typeof u[tdcSidebar.currentViewportSettings.name]?"":u[tdcSidebar.currentViewportSettings.name]}catch(w){}b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+m+" "+l+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+
d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+r+'" data-min="'+g+'" data-max="'+f+'" data-step="'+k+'" min="'+g+'" max="'+f+'" step="'+k+'" value="'+r+'" '+x+" />");b=b+('<input type="text" class="tdc_range_value" data-default_value="'+n+'" '+h+' value="'+r+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeMultiple:function(a,
c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var k="";_.has(a,"toggle_enabled_by")&&
""!==a.toggle_enabled_by&&(k='data-enabled-by="'+a.toggle_enabled_by+'"');var n=a.tdc_values,h=tdcSidebarPanel._getParameterCurrentValue(a,c),m="",l="",p=[],x="",r="",u="",w="",z="",A="",B="",q;for(q in n)n.hasOwnProperty(q)&&(p.push(n[q].unit),""===r||""===x)&&(w=n[q].unit,r=' data-range_unit="'+w+'" ',u=n[q].value,x=' data-range_value="'+u+'" ',z=n[q].range_min,A=n[q].range_max,B=n[q].range_step);if(""!==h){for(var v=[],y=0;y<p.length&&!(v=h.split(p[y]),1<v.length);y++);v.length&&(w=p[y],r=' data-range_unit="'+
w+'" ',u=v[0],x=' data-range_value="'+u+'" ')}for(q in n)n.hasOwnProperty(q)&&(h=_.uniqueId(),m+=" data-value_"+q+'="'+n[q].value+'" ',m+=" data-min_"+q+'="'+n[q].range_min+'" ',m+=" data-max_"+q+'="'+n[q].range_max+'" ',m+=" data-step_"+q+'="'+n[q].range_step+'" ',p=n[q].value,v="",n[q].unit===w&&(p=u,z=n[q].range_min,A=n[q].range_max,B=n[q].range_step,v="checked"),l+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+q+'" data-unit_value="'+n[q].unit+'" type="radio" id="'+
h+'" '+v+' data-default_value="'+n[q].value+'" data-last_value="'+p+'"/>',l+='<label for="'+h+'">'+n[q].unit+"</label>");b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+k+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+x+" "+r+" "+
m+' min="'+z+'" max="'+A+'" step="'+B+'" value="'+u+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+l+'</div><input type="text" class="tdc_range_value" value="'+(u+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+"</span>";return b+="</div>"},addRangeMultipleResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==
...
c),m="",l="",p=[],x=' data-responsive="" ',r="",u="",w="",z="",A="",B="",q="",v;for(v in n)n.hasOwnProperty(v)&&(p.push(n[v].unit),""===u||""===r)&&(z=n[v].unit,u=' data-range_unit="'+z+'" ',w=n[v].value,r=' data-range_value="'+w+'" ',A=n[v].range_min,B=n[v].range_max,q=n[v].range_step);if(""!==h){var y=h;try{var C=JSON.parse(window.atob(h));x=' data-responsive="'+h+'" ';y="undefined"===typeof C[tdcSidebar.currentViewportSettings.name]?"":C[tdcSidebar.currentViewportSettings.name]}catch(E){}if(""!==
y){h=[];for(C=0;C<p.length&&!(h=y.split(p[C]),1<h.length);C++);h.length&&(z=p[C],u=' data-range_unit="'+z+'" ',w=h[0],r=' data-range_value="'+w+'" ')}}for(v in n)n.hasOwnProperty(v)&&(p=_.uniqueId(),m+=" data-value_"+v+'="'+n[v].value+'" ',m+=" data-min_"+v+'="'+n[v].range_min+'" ',m+=" data-max_"+v+'="'+n[v].range_max+'" ',m+=" data-step_"+v+'="'+n[v].range_step+'" ',y=n[v].value,h="",n[v].unit===z&&(y=w,A=n[v].range_min,B=n[v].range_max,q=n[v].range_step,h="checked"),l+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+
...
c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+r+" "+u+" "+m+" "+x+' min="'+A+'" max="'+B+'" step="'+q+'" value="'+w+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+l+'</div><input type="text" class="tdc_range_value" value="'+(w+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+"</span>";return b+="</div>"},addIconSelector:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+
