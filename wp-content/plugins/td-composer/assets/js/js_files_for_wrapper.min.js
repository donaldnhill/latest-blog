...
tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(b);c.tdc_header_template_id=a;c.tdc_header_template_content=b;c.tdc_assoc_header_template=tdcState.isGlobalHeaderTemplate()?"":!0;return c},cloudLoadHeaderTemplate:function(a,e,c,g,l){b.isUndefined(a)||(g={td_magic_token:tdcLivePanel.$token.val(),tdc_action:"load_header_template",tdc_header_template_content:a,tdc_header_template_title:g},b.isUndefined(c)||(g.tdc_header_template_id=c),b.isUndefined(l)||(g.tdc_header_is_mobile=l),f.ajax({timeout:1E4,
...
e),b.isUndefined(window.tdcPostSettings.prevTemplateType)||(window.tdcPostSettings.tdbTemplateType=window.tdcPostSettings.prevTemplateType,window.tdcPostSettings.prevTemplateType=d))}).fail(function(a,b,e){}))},assignCloudLoadHeaderTemplate:function(a,e,c,g,l,n,k){b.isUndefined(a)||(a={td_magic_token:tdcLivePanel.$token.val(),tdc_action:"load_header_template",tdc_header_template_content:a,tdc_header_template_title:g,tdc_header_is_mobile:!0},b.isUndefined(c)||(a.tdc_header_template_id=c),b.isUndefined(l)||
...
tdcOperationUI.getDraggedElement(),e=tdcOperationUI.getCurrentElementOver(),c=tdcAdminWrapperUI.$placeholder,g="";if(!(b.isUndefined(a)||b.isUndefined(e)||b.isUndefined(c)||!c.is(":visible")&&e!==tdcAdminWrapperUI.$recycle)){var l=tdcOperationUI.isSidebarElementDragged(),n=tdcOperationUI.isElementDragged(),k=!1,m=!1,p=!1,q=!1,r=!1,t=!1,v=tdcOperationUI.isElementWithRowDragged(),u=tdcOperationUI.getRowStartValues();if(n){var x=a.closest(".tdc-elements");if(!l&&(g=tdcIFrameData._getSourceCol(tdcOperationUI.getDraggedElement()),
b.isUndefined(g)))return}else(k=tdcOperationUI.isInnerColumnDragged())&&(x=a.closest(".tdc-inner-columns"));!k&&(m=tdcOperationUI.isInnerRowDragged(),p=tdcOperationUI.isTempInnerRowDragged(),m||p)&&(x=a.closest(".tdc-elements"));m||p||(q=tdcOperationUI.isColumnDragged())&&(x=a.closest(".tdc-columns"));!q&&(r=tdcOperationUI.isRowDragged(),t=tdcOperationUI.isTempRowDragged(),r||t)&&(x=a.closest(".tdc-rows"));if(l||n||k||m||p||q||r||t){var B="",z=a.find(".td_block_inner");z.length&&(B=z.attr("id"));
if(!l&&!b.isUndefined(x)&&x.length){var w=x.children();z=w.index(a);var y=w.index(c);if(e!==tdcAdminWrapperUI.$recycle&&-1!==y&&1===Math.abs(z-y))return;if(n||m||p||r||t){if((n||m||r)&&e===tdcAdminWrapperUI.$recycle){c="Deleting ";tdConfirm.showModal(m?c+"inner row":r?c+"row":c+"element",tdcOperationUI,function(){if((-1===y&&1===w.length||2===w.length&&-1!==y)&&(!r||1!==tdcIFrameData.tdcRows.length)){var b="";A=a.closest(".tdc-inner-column");A.length?b=" tdc-element-inner-column":(C=a.closest(".tdc-column"),
...
var l=tdcOperationUI.getDraggedElement();l.insertAfter(tdcRowHandlerUI.$elementRow);tdcRowUI.bindRow(l);var n=l.prevAll(".tdc-row").length,k=new tdcIFrameData.TdcModel({content:"",attrs:b.clone(a.get("attrs")),tag:"vc_row",type:"closed",level:1,parentModel:e});new tdcIFrameData.TdcLiveView({model:k,el:l[0]});var m=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:k});l.data("model_id",k.cid);c.add(k,{at:n});c=new tdcIFrameData.TdcCollection;c.add(m);
k.set("childCollection",c);m.set("childCollection",new tdcIFrameData.TdcCollection);document.dispatchEvent(new CustomEvent("tdc.modelCloned",{detail:{model:k,position:n,destination:e}}));k.getShortcodeRender(3,"",!0,a);tdcOperationUI.setDraggedElement(d);tb_remove()}}},[a],"Are you sure you want to clone the current row and all its elements?"),tdcRowHandlerUI._inCloneOperation=!1},deleteHandler:function(a){null!==a&&a.preventDefault();a.preventDefault();a.stopPropagation();tdConfirm.showModal("Delete row",
tdcRowHandlerUI,function(a){tdcOperationUI.setDraggedElement(tdcRowHandlerUI.$elementRow);tdcOperationUI.setCurrentElementOver(tdcAdminWrapperUI.$recycle);a=tdcOperationUI.getDraggedElement();var b=tdcAdminWrapperUI.$placeholder;a=a.closest(".tdc-elements");var c=a.children();b=c.index(b);if(-1===b&&1===c.length||2===c.length&&-1!==b)b="",tdcElementHandlerUI.$element.closest(".tdc-inner-column").length?b=" tdc-element-inner-column":tdcElementHandlerUI.$element.closest(".tdc-column").length&&(b=" tdc-element-column"),
...
!0,!1);k=new tdcIFrameData.TdcCollection;a.set("childCollection",k);m={};b.each(c,function(b,c,e){tdcIFrameData._getData(a,b,m)});b.isEmpty(m)||(tdcDebug.log(m),new tdcNotice.notice("Errors happened in templateContent during tdcIFrameData.changeData() -> _getData()!",!0,!1));c={error:d,shortcode:d};tdcIFrameData.checkCurrentData(c);b.isUndefined(c.error)||(tdcDebug.log(c.error),new tdcNotice.notice(m,!0,!1));k=a.get("childCollection");if(p.length!==k.length){new tdcNotice.notice("Errors happened in templateContent during() tdcIFrameData.TdcLiveView -> customRender!",
...
!0,!1);var l=tdcIFrameData._getDestinationCol(a.$refEl);g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection);var n=g.get("childCollection");var k={},m=c.data("start-values"),p;"undefined"!==typeof m&&(m=JSON.parse(tdcUtil.b64DecodeUnicode(m)),"undefined"!==typeof m&&(b.isArray(m)&&m.length?(k=m[0],1<m.length&&(p=m)):k=m));m=c.data("shortcodeName");m=new tdcIFrameData.TdcModel({content:"",attrs:k,tag:m,type:"single",level:4,parentModel:g});new tdcIFrameData.TdcLiveView({model:m,
el:c[0]});b.isUndefined(p)||m.set("presetValues",p);tdcElementUI.bindElement(c);tdcRecycle.takeSnapshot(m.get("tag")+" : sidebar element added");c.data("model_id",m.cid);n.add(m,{at:h});m.set("parentModel",g);m.getShortcodeRender(l,a.draggedBlockUid,!0)}else if(a.wasTempInnerRowDragged)tdcRecycle.takeSnapshot("Sidebar inner-row added"),g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]),b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",
!0,!1),l=tdcIFrameData._getDestinationCol(a.$refEl),g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection),n=g.get("childCollection"),p=c.data("templateContent"),b.isUndefined(p)?(k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row_inner",type:"closed",level:3,parentModel:g}),new tdcIFrameData.TdcLiveView({model:k,el:c[0]}),m=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",type:"closed",level:4,parentModel:k}),c.data("model_id",k.cid),n.add(k,
{at:h}),p=new tdcIFrameData.TdcCollection,p.add(m),k.set("childCollection",p),p=new tdcIFrameData.TdcCollection,m.set("childCollection",p)):(k=new tdcIFrameData.TdcModel({templateContent:p,attrs:{},tag:"vc_row_inner",type:"template",level:3,parentModel:g}),new tdcIFrameData.TdcLiveView({model:k,el:c[0]}),m={},p=c.data("startValues"),"undefined"!==typeof p&&(m=JSON.parse(window.atob(p))),k.set({attrs:m}),c.data("model_id",k.cid),n.add(k,{at:h})),k.getShortcodeRender(l,a.draggedBlockUid,!0);else if(a.wasTempRowDragged)if(tdcRecycle.takeSnapshot("Sidebar row added"),
...
attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q});c.data("model_id",q.cid);h=c.prevAll(".tdc-row").length;n.add(q,{at:h});var r=new tdcIFrameData.TdcCollection;r.add(k);q.set("childCollection",r);l=new tdcIFrameData.TdcCollection;k.set("childCollection",l);if(a.wasElementWithRowDragged){p={};r={};m=c.data("start-values");var t=c.data("row-start-values");"undefined"!==typeof t&&(r=JSON.parse(window.atob(t)));q.set({attrs:r});"undefined"!==typeof m&&(p=JSON.parse(window.atob(m)),b.isArray(p)&&
(p=p[0]));m=c.data("shortcodeName");m=new tdcIFrameData.TdcModel({content:"",attrs:p,tag:m,type:"single",level:3,parentModel:k});l.add(m);l=new tdcIFrameData.TdcCollection;m.set("childCollection",l)}document.dispatchEvent(new CustomEvent("tdc.newModelCreated",{detail:{model:q,position:h,destination:g}}));q.getShortcodeRender(1,a.draggedBlockUid,!0)}else m=c.data("shortcodeName"),b.isUndefined(m)||"tdc_zone"!==m?(q=new tdcIFrameData.TdcModel({templateContent:p,attrs:{},tag:"vc_row",type:"template",
...
0!==e&&(c=f(c[0].outerHTML).insertBefore(c),c.html(""),c.addClass("tdc-dropped"));var l=new tdcIFrameData.TdcModel({templateContent:window.btoa(d),attrs:{},tag:"vc_row",type:"template",level:1,parentModel:g});new tdcIFrameData.TdcLiveView({model:l,el:c[0]});h=c.prevAll(".tdc-row").length;c.data("model_id",l.cid);b.isUndefined(g)||(n.add(l,{at:h}),g.set("childCollection",n),l.set("childCollection",new tdcIFrameData.TdcCollection));document.dispatchEvent(new CustomEvent("tdc.newModelCreated",{detail:{model:l,
position:h,destination:g}}));l.getShortcodeRender(1,a.draggedBlockUid,!0)},500+2E3*parseInt(e,10))}));else if(a.wasColumnDragged){if(tdcRecycle.takeSnapshot("Column copied"),p=c.data("templateContent"),!b.isUndefined(p)){m=c.data("model_id");if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,!1);return}k=tdcIFrameData.getModel(m);if(b.isUndefined(k)){new tdcNotice.notice("changeData Error: Column model not in structure data!",!0,!1);return}k.set("templateContent",
p);k.set("type","template");l=tdcIFrameData._getDestinationCol(a.$refEl);k.getShortcodeRender(l,a.draggedBlockUid,!0)}}else{if(a.wasInnerColumnDragged&&(tdcRecycle.takeSnapshot("Inner column copied"),p=c.data("templateContent"),!b.isUndefined(p))){l=c.data("model_id");if(b.isUndefined(l)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,!1);return}m=tdcIFrameData.getModel(l);if(b.isUndefined(l)){new tdcNotice.notice("changeData Error: Column model not in structure data!",
!0,!1);return}m.set("templateContent",p);m.set("type","template");l=tdcIFrameData._getDestinationCol(a.$refEl);m.getShortcodeRender(l,a.draggedBlockUid,!0)}}else{m=c.data("model_id");if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Element model id is not in $refEl data!",!0,!1);return}m=tdcIFrameData.getModel(m);if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Element model not in structure data!",!0,!1);return}if(a.wasElementDragged){tdcDebug.log("case 1");if(tdcOperationUI.getCurrentElementOver()===
tdcAdminWrapperUI.$recycle){tdcDebug.log("element recycled");tdcIFrameData.removeModel(m);tdcRecycle.takeSnapshot(m.get("tag")+" : element recycled");return}tdcRecycle.takeSnapshot(m.get("tag")+" : element moved");p=m.get("parentModel");g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-inner-column",".tdc-column"]);b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);p.cid===g.cid?(l=p.get("childCollection"),l.remove(m,{silent:!0}),l.add(m,
{at:h})):(l=tdcIFrameData._getDestinationCol(a.$refEl),g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection),n=g.get("childCollection"),tdcIFrameData.removeModel(m,!1,{silent:!0}),n.add(m,{at:h}),m.set("parentModel",g),a.sourceColParam!==l&&m.getShortcodeRender(l,a.draggedBlockUid,!0));tdcRecycle.takeSnapshot(m.get("tag")+" : element moved")}else if(a.wasInnerRowDragged){tdcDebug.log("case 2");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("inner row recycled");
tdcIFrameData.removeModel(m);tdcRecycle.takeSnapshot("Inner row recycled");return}tdcRecycle.takeSnapshot("Inner row moved");p=m.get("parentModel");g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]);b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);if(p.cid===g.cid)l=p.get("childCollection"),l.remove(m,{silent:!0}),l.add(m,{at:h});else{g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection);n=g.get("childCollection");
tdcIFrameData.removeModel(m,!0,{silent:!0});n.add(m,{at:h});m.set("parentModel",g);p=p.get("attrs");r=g.get("attrs");if(b.has(p,"width"))switch(p.width){case "1/3":l="13";break;case "2/3":l="23"}if(b.has(r,"width"))switch(r.width){case "1/3":k="13";break;case "2/3":k="23"}b.isUndefined(l)&&(l="11");b.isUndefined(k)&&(k="11");if(l!==k&&(p=m.get("childCollection"),!b.isUndefined(p))){p=tdcIFrameData.getChildCollectionWidths(p);b.isUndefined(p)&&(p="11");r="11";t=1;switch(k){case "11":switch(p){case "11":r=
"11";break;case "23_13":r="23_13";break;case "13_23":r="13_23";break;case "12_12":r="13_13_13";break;case "13_13_13":r="13_13_13"}t=3;break;case "13":switch(p){case "11":r="11";break;case "23_13":r="11";break;case "13_23":r="11";break;case "12_12":r="11";break;case "13_13_13":r="11"}break;case "23":switch(p){case "11":r="12_12";break;case "23_13":r="12_12";break;case "13_23":r="12_12";break;case "12_12":r="12_12";break;case "13_13_13":r="12_12"}t=2}if(p!==r||l!==k)tdcIFrameData.changeInnerRowModel(m,
p,r),m.getShortcodeRender(t,null,!0)}l=tdcOperationUI.inZone(c);k=tdcOperationUI.inRow(c);p=tdcOperationUI.inColumn(c);r=tdcOperationUI.inInnerRow(c);b.isUndefined(l)||b.isUndefined(k)||b.isUndefined(p)||b.isUndefined(r)||tdcSidebar.setSettings({$currentZone:l,$currentRow:k,$currentColumn:p,$currentInnerRow:r},!0)}tdcRecycle.takeSnapshot(m.get("tag")+" : inner row moved")}else if(a.wasInnerColumnDragged||a.wasColumnDragged)tdcDebug.log("case 3"),p=m.get("parentModel"),l=p.get("childCollection"),l.remove(m,
{silent:!0}),l.add(m,{at:h}),a.wasColumnDragged?(l=tdcOperationUI.inZone(c),k=tdcOperationUI.inRow(c),b.isUndefined(k)||b.isUndefined(l)||tdcSidebar.setSettings({$currentZone:l,$currentRow:k}),tdcRecycle.takeSnapshot("Column moved")):a.wasInnerColumnDragged&&(l=tdcOperationUI.inZone(c),k=tdcOperationUI.inRow(c),p=tdcOperationUI.inColumn(c),r=tdcOperationUI.inInnerRow(c),b.isUndefined(l)||b.isUndefined(k)||b.isUndefined(p)||b.isUndefined(r)||tdcSidebar.setSettings({$currentZone:l,$currentRow:k,$currentColumn:p,
$currentInnerRow:r}),tdcRecycle.takeSnapshot("Inner-column moved"));else if(a.wasRowDragged){tdcDebug.log("case 4");p=m.get("parentModel");k=p.get("blockUid");l=p.get("childCollection");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){l.remove(m);tdcDebug.log("row recycled");tdcRecycle.takeSnapshot("Row recycled");l.length||(q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:p}),new tdcIFrameData.TdcLiveView({model:q,el:tdcIFrameData.iframeContents.find("#"+
k+" .tdc_zone")[0]}),k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q}),l.add(q,{at:0}),r=new tdcIFrameData.TdcCollection,r.add(k),q.set("childCollection",r),k.set("childCollection",new tdcIFrameData.TdcCollection),q.getShortcodeRender(1,a.draggedBlockUid,!0),document.dispatchEvent(new CustomEvent("tdc.newModelCreated",{detail:{model:q,position:0,destination:p}})));document.dispatchEvent(new CustomEvent("tdc.modelDeleted",{detail:{model:m,source:p}}));
return}h=c.prevAll(".tdc-row").length;r=c.closest(".tdc-zone").data("model_id");g=tdcIFrameData.getModel(r);n=l;p.cid!==r&&(n=g.get("childCollection"),g.set("childCollection",n),m.set("parentModel",g));l.remove(m,{silent:!0});n.add(m,{at:h});tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(c)});l.length||(q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:p}),new tdcIFrameData.TdcLiveView({model:q,el:tdcIFrameData.iframeContents.find("#"+k+" .tdc_zone")[0]}),
k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q}),l.add(q,{at:0}),r=new tdcIFrameData.TdcCollection,r.add(k),q.set("childCollection",r),k.set("childCollection",new tdcIFrameData.TdcCollection),setTimeout(function(){q.getShortcodeRender(1,d,!0)},200));p.set("childCollection",l);tdcRecycle.takeSnapshot("Row moved");tdcDebug.log("newPosition: "+h);tdcDebug.log(c);document.dispatchEvent(new CustomEvent("tdc.modelPositionChanged",{detail:{model:m,newPosition:h,
...
e.get("tag")&&(e=e.get("childCollection"),!b.isUndefined(e)&&e.length)){var l="";b.each(e.models,function(a,c,d){a=a.get("attrs");!b.isUndefined(a)&&b.isObject(a)&&b.has(a,"width")&&(l=c===d.length-1?l+a.width:l+(a.width+"_"))});l=l.replace(/\//g,"");"12_12"!==l&&"23_13"!==l&&"13_23"!==l&&"13_13_13"!==l&&(l="");if("11"===c)if("23"===d)if("23_13"===l){var k=e.at(0),f=e.at(1);g=k.get("attrs");h=f.get("attrs");g=b.clone(g);h=b.clone(h);g.width="1/2";h.width="1/2";k.set("attrs",g);f.set("attrs",h)}else if("13_23"===
l)k=e.at(0),f=e.at(1),g=k.get("attrs"),h=f.get("attrs"),g=b.clone(g),h=b.clone(h),g.width="1/2",h.width="1/2",k.set("attrs",g),f.set("attrs",h);else if("13_13_13"===l){k=e.at(0);f=e.at(1);e=e.at(2);g=k.get("attrs");h=f.get("attrs");var n=e.get("attrs");g=b.clone(g);h=b.clone(h);b.clone(n);g.width="1/2";h.width="1/2";k.set("attrs",g);f.set("attrs",h);h=e.get("childCollection");if(!b.isUndefined(h)&&h.length){var m=f.get("childCollection");b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,f.set("childCollection",
m));b.each(h.models,function(a,b,c){m.add(a);a.set("parentModel",f)})}tdcIFrameData.removeModel(e)}else{if(e.models.length){k=e.at(0);g=k.get("attrs");g=b.clone(g);var u=k.get("childCollection");delete g.width;k.set("attrs",g);b.isUndefined(u)&&(u=new tdcIFrameData.TdcCollection,k.set("childCollection",u));var x=0;for(b.each(e.models,function(a,c,d){0!==c&&(x=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);u.add(a)}))});0<x;)tdcIFrameData.removeModel(e.at(x)),
x--}}else{if("13"===d&&e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),u=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(u)&&(u=new tdcIFrameData.TdcCollection,k.set("childCollection",u)),x=0,b.each(e.models,function(a,c,d){0!==c&&(x=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);u.add(a)}))});0<x;)tdcIFrameData.removeModel(e.at(x)),x--}else if("23"===c)if("11"===d)if("12_12"===l)k=e.at(0),f=e.at(1),g=k.get("attrs"),
...
x;)tdcIFrameData.removeModel(e.at(x)),x--}else if("13"===c)if("11"===d)if(""===l||"12_12"!==l&&"23_13"!==l&&"13_23"!==l&&"13_13_13"!==l){if(e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),u=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(u)&&(u=new tdcIFrameData.TdcCollection,k.set("childCollection",u)),x=0,b.each(e.models,function(a,c,d){0!==c&&(x=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);u.add(a)}))});0<
x;)tdcIFrameData.removeModel(e.at(x)),x--}else"12_12"===l&&e.models.length&&(k=e.at(0),f=e.at(1),g=k.get("attrs"),h=f.get("attrs"),g.width="1/3",h.width="1/3",k.set("attrs",g),f.set("attrs",h),e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));else if("23"===d&&(""===l||"12_12"!==l)&&e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),u=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(u)&&(u=
...
function(a,b,c){a.set("parentModel",q);h.add(a)}),!b.isUndefined(e)&&e.length&&b.each(e.models,function(a,b,c){a.set("parentModel",q);h.add(a)}),tdcIFrameData.removeModel(k)):(m=d.split("_"),p=m[0].charAt(0)+"/"+m[0].charAt(1),c=m[1].charAt(0)+"/"+m[1].charAt(1),q=e.at(0),r=q.get("attrs"),k=e.at(1),d=k.get("attrs"),f=k.get("childCollection"),a=e.at(2),e=a.get("childCollection"),r=b.clone(r),r.width=p,q.set("attrs",r),d=b.clone(d),d.width=c,k.set("attrs",d),b.isUndefined(f)&&(f=new tdcIFrameData.TdcCollection,
...
h.add(a)});tdcIFrameData.removeModel(k)}else m=d.split("_"),p=m[0].charAt(0)+"/"+m[0].charAt(1),c=m[1].charAt(0)+"/"+m[1].charAt(1),q=e.at(0),r=q.get("attrs"),k=e.at(1),d=k.get("attrs"),r=b.clone(r),r.width=p,q.set("attrs",r),d=b.clone(d),d.width=c,k.set("attrs",d),3===m.length&&e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:m[2].charAt(0)+"/"+m[2].charAt(1)},type:"closed",level:3,parentModel:a}));else{var k=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",
type:"closed",level:3,parentModel:a}),m=d.split("_"),p=m[0].charAt(0)+"/"+m[0].charAt(1);c=m[1].charAt(0)+"/"+m[1].charAt(1);var q=e.at(0),r=q.get("attrs");b.isUndefined(r)?q.set("attrs",{width:p}):(r=b.clone(r),r.width=p,q.set("attrs",r));k.set("attrs",{width:c});e.add(k);3===m.length&&e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:m[2].charAt(0)+"/"+m[2].charAt(1)},type:"closed",level:3,parentModel:a}))}}},getChildCollectionWidths:function(a){if(!b.isUndefined(a)){var c;
...
function(b){var c=jQuery(this),a=c.closest(".tdc-property-responsive"),e=a.find('input[type="range"]'),h=a.find('input[type="radio"]:checked'),g=a.find('input[type="text"]'),l=e.get(0),f="",k=h.data("default_value"),m=tdcIFrameData.getModel(e.data("model_id")),p=e.data("param_name"),q=window.tdcAdminSettings.mappedShortcodes[m.attributes.tag],r=m="";var t=[];for(var v=0;v<q.params.length;v++)if(p===q.params[v].param_name){v=q.params[v].tdc_values;for(var u in v)v.hasOwnProperty(u)&&(t.push(v[u].unit),
""===m||""===r)&&(m=v[u].value,r=v[u].unit);break}h.length&&(f=h.data("unit_value"));if("range"===c.attr("type"))t=e.val(),g.val(t),h.data("last_value",t),g.val(t),e.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(e.attr("name"),t+f,tdcSidebar.currentViewportSettings.name)),a.removeClass("tdc-css-inherited");else if("text"===c.attr("type")){if("input"===b.type||"change"===b.type)return;a.removeClass("tdc-css-inherited");t=g.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
...
!0),l.min=u,l.max=h,l.step=q,l.value=m,f.data("last_value",m),g.val(m),a.addClass("tdc-css-inherited");else for(v=0;v<q.params.length;v++){if(p===q.params[v].param_name){t=[];g=[];v=q.params[v].tdc_values;for(u in v)v.hasOwnProperty(u)&&t.push(v[u].unit);for(v=0;v<t.length&&!(g=f.split(t[v]),1<g.length);v++);g.length&&(m=g[0],r=t[v],e.data("range_value",m),e.data("range_unit",r),f=a.find('input[type="radio"][data-unit_value="'+r+'"]'),q=f.data("unit"),u=e.data("min_"+q),h=e.data("max_"+q),q=e.data("step_"+
...
c.on("mousedown",function(b){var c=jQuery("#tdc-sidebar"),a=jQuery("#tdc-icon-selector"),e=jQuery("#tdc-gradient"),h=jQuery("#tdc-palette"),g=jQuery("#tdc-font-list"),l=jQuery(".tdc-preset-values-list");a.length?a.get(0).contains(b.target)||(a.hide(),c.after(a)):a=tdcSidebar.buildIconSelector();e.length?e.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-gradient-wrap")||(e.hide(),c.after(e))):e=tdcSidebar.buildGradient();h.length?h.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-colorpicker-wrap")||
(h.hide(),c.after(h),h.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):h=tdcSidebar.buildPalette();g.length&&!g.get(0).contains(b.target)&&(g.hide(),c.after(g));!l.length||l.get(0).contains(b.target)||jQuery(".tdc-preset-values").get(0).contains(b.target)?l.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(b.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),
...
textYes:"Yes",objectContext:this,callbackYes:function(){tb_remove();var b=jQuery(this),a=b.data("model_id"),c=tdcIFrameData.getModel(a),h=c.get("attrs");h=_.clone(h);for(var g="font-family font-size font-line-height font-style font-weight font-transform font-spacing".split(" "),l="",f=0;f<g.length;f++){var k=b.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+g[f]+":first");if(k.length){var m=k.find('[data-model_id="'+a+'"]');m.length&&(m.val(""),m.data("responsive",""),k.removeClass("tdc-css-inherited"),
l=k.find(".tdc-inherit"),l.length&&l.hide(),l=m.data("placeholder"),"undefined"!==typeof l&&m.attr("placeholder",l),l=m.data("param_name"),delete h[l],m=m.attr("name"),tdcSidebarPanel.deleteResponsiveValues(m))}}c.set("attrs",h);tdcSidebarController.onUpdate(c,l,"","")}})});c.on("click",".tdc-sidebar-font-save",function(b){b=jQuery(this);var c=b.data("model_id");c=tdcIFrameData.getModel(c).get("attrs");var a=b.data("param_name").replace("font_settings",""),e="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" "),
...
if("undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts){jQuery('<div class="tdc-font-list-header"><span>Recent fonts</span></div>').appendTo(h);b=_.invert(window.tdcAdminSettings.mappedFontFamily);for(var g=window.tdcAdminSettings.tdcSavings.recentFonts.length;0<g;g--){var l=window.tdcAdminSettings.tdcSavings.recentFonts[g],f=b[l];_.isUndefined(f)||jQuery('<div class="tdc-recent-font-settings" data-value="'+l+'" data-model_id="'+a+'" data-param_name="'+e+'"><span class="tdc-font-name">'+
...
b){_.isUndefined(b)&&(b=jQuery(c.currentTarget).data("model_id"),b=tdcIFrameData.getModel(b),c={error:f},_.isUndefined(b)||tdcIFrameData._checkModelData(b,c));var d=b.get("tag");b=b.get("attrs");b=_.clone(b);if(!_.isUndefined(b)){var a={};c={};for(var e in b)0===e.indexOf("tds_")&&(a[e]=b[e]);e=window.tdcAdminSettings.mappedShortcodes[d].params;for(d=0;d<e.length;d++){var h=!1,g=e[d];if(0===g.param_name.indexOf("tds_")){for(var l in a)if(g.param_name===l){c[l]=a[l];h=!0;break}h||(c[g.param_name]=
"")}}for(l in a)switch(a=l.split("-"),a.length){case 2:if(!_.has(c,l)){e=a[0];a=!1;for(var n in c)if(e===c[n]&&1===n.split("-").length){a=!0;break}if(!a){var k;for(k in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[k],e)){var m=k;break}_.has(c,m)&&""===c[m]&&window.tdcAdminSettings.globalStyle[m]===e&&(a=!0)}a||delete b[l]}break;case 3:e=a[0];d=a[2];for(k in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[k],e)){m=k;break}a=
!1;for(n in c)if(e===c[n]&&n===m+"-"+d){a=!0;break}a||_.has(c,m+"-"+d)&&""===c[m+"-"+d]&&window.tdcAdminSettings.globalStyle[m]===e&&(a=!0);a||delete b[l]}return b}},getCurrentListAtts:function(c,b,d){_.isUndefined(b)&&(c=jQuery(c.currentTarget).data("model_id"),b=tdcIFrameData.getModel(c),c={error:f},_.isUndefined(b)||tdcIFrameData._checkModelData(b,c));c=b.get("tag");b=b.get("attrs");var a=_.clone(b);if(!_.isUndefined(a)){var e={};b={};for(var h in a)0===h.indexOf("tds_")&&(e[h]=a[h]);h=window.tdcAdminSettings.mappedShortcodes[c].params;
for(var g=0;g<h.length;g++){var l=!1,n=h[g];if(0===n.param_name.indexOf("tds_")){for(var k in e)if(n.param_name===k){b[k]=e[k];l=!0;break}l||(b[n.param_name]="")}}for(k in e)switch(e=k.split("-"),e.length){case 2:if(!_.has(b,k)){h=e[0];e=!1;for(var m in b)if(h===b[m]&&1===m.split("-").length){e=!0;break}if(!e){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],h)){var q=p;break}_.has(b,q)&&""===b[q]&&window.tdcAdminSettings.globalStyle[q]===h&&(e=
!0)}e||delete a[k]}break;case 3:h=e[0];l=e[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],h)){q=p;break}e=!1;for(m in b)if(h===b[m]&&m===q+"-"+l){e=!0;break}e||_.has(b,q+"-"+l)&&""===b[q+"-"+l]&&window.tdcAdminSettings.globalStyle[q]===h&&(e=!0);e||delete a[k]}var r=[],t;for(t in window.tdcAdminSettings.listStyles[d])if(t===c){for(g=0;g<window.tdcAdminSettings.listStyles[d][t].length;g++)k=window.tdcAdminSettings.listStyles[d][t][g],_.isArray(k)?
...
_.isEmpty(b.params[a].group)||(e=b.params[a].group);d.push(e)}d=_.uniq(d);var h=e="",g=tdcSidebar.getCurrentTabId(),l,f;e+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var k=f=l="";for(a=0;a<d.length;a++){h=tdcSidebarPanel._fixGroupName(d[a]);var m=tdcUtil.makeSafeForCSS(h);if(0===a)l='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>',f='<a href="#" data-tab-id="td-tab-'+m+'" title="'+h+' settings">'+
h+'<span class="tdc-tab-search-notice"></span></a>';else if(_.isUndefined(g)||g!=="td-tab-"+m){var p=c.getParentModel("vc_row");"ai"===m&&(_.isUndefined(window.TdAiBuilderModal)||!_.isUndefined(p)&&(_.isUndefined(p.attributes.attrs.aib_is_section)||"yes"!==p.attributes.attrs.aib_is_section))||"css"===m&&"td-aib-style"===window.tdcPostSettings.loadDataFromPostType||(k+='<a href="#" data-tab-id="td-tab-'+m+'" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>')}else l=f,k+=
'<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>'}e=e+(l+k)+"</div>";k=f=l=a="";if(tdcState.isMobileComposer())switch(tdcSidebar.currentViewportSettings.name){case "all":a="selected";break;case "phone":k="selected"}else switch(tdcSidebar.currentViewportSettings.name){case "all":a="selected";break;case "landscape":l="selected";break;case "portrait":f="selected";break;case "phone":k="selected"}e+='<div class="tdc-tab-responsive"><div class="tdc-responsive-buttons">';
...
e+='<div class="tdc-sidebar-sticky-a"></div>';e+='<div class="tdc-sidebar-sticky-b"></div>';e+='<div class="tdc-tab-content-wrap" data-tag="'+c.get("tag")+'">';k=f=l="";for(a=0;a<d.length;a++)h=tdcSidebarPanel._fixGroupName(d[a]),m=tdcUtil.makeSafeForCSS(h),h="tdc-tab-no-design",p=c.get("tag"),"css"===m&&(h="tdc-tab-design"),0===a?(l='<div class="tdc-tab-content tdc-tab-content-visible '+h+'" id="td-tab-'+m+'">',f='<div class="tdc-tab-content '+h+'" id="td-tab-'+m+'">',m=window.tdcAdminSettings.mappedShortcodes[p].tdc_start_values,
c.unset("presetValues"),_.isUndefined(m)||(m=JSON.parse(window.atob(m)),_.isArray(m)&&1<m.length&&c.set("presetValues",m)),c.has("presetValues")&&(m=c.get("presetValues"),k+=tdcSidebarPanel._addPresetValuesSelector(m,c))):_.isUndefined(g)||g!=="td-tab-"+m?k+='<div class="tdc-tab-content '+h+'" id="td-tab-'+m+'">':(l=f,k+='<div class="tdc-tab-content tdc-tab-content-visible '+h+'" id="td-tab-'+m+'">'),k+=tdcSidebarPanel._bindGroupAndGetHtml(d[a],b,c),m=' data-model_id="'+c.cid+'" ',"dev"===window.tdcAdminSettings.deployMode&&
...
b,d){var a="",e=d.get("attrs");if("tdc_zone"===d.get("tag"))var h=e.type;for(var g=0;g<b.params.length;g++){var l=b.params[g].param_name,f=b.params[g].group;if(c===tdcSidebarPanel._defaultGroupName&&_.isEmpty(b.params[g].group)||b.params[g].group===c){if(!_.isUndefined(h)){if(!_.isUndefined(b.params[g].zone_group)&&h!==b.params[g].zone_group||"type"===l)continue;if("mob_load"===l&&!_.includes(["tdc_header_desktop","tdc_header_desktop_sticky"],h))continue;if("desktop_load"===l&&!_.includes(["tdc_header_mobile",
"tdc_header_mobile_sticky"],h))continue}a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[g],d)}if("block_template_id"===l){f=e.block_template_id;_.isEmpty(f)&&(f=window.tdcAdminSettings.globalBlockTemplate);l=window.tdcAdminSettings.mappedBlockTemplates;for(var k=0;k<l[f].params.length;k++)if(c===tdcSidebarPanel._defaultGroupName&&_.isEmpty(l[f].params[k].group)||l[f].params[k].group===c)a+=tdcSidebarPanel._bindParamAndGetHtml(l[f].params[k],d)}else if(0===l.indexOf("tds_")){var m=l.split("-");k=
m[0];var p;2===m.length?p=m[1]:2<m.length&&new tdcNotice.notice('Param "'+l+'" must have up to at most one "-" separator ',!0,!1);l=e[l];_.isEmpty(l)&&(l=window.tdcAdminSettings.globalStyle[k]);m=window.tdcAdminSettings.settingsStyle[k];if("undefined"!==typeof m[l])for(k=0;k<m[l].params.length;k++)if(f==c||_.isUndefined(f)&&c===tdcSidebarPanel._defaultGroupName){var q=JSON.parse(JSON.stringify(m[l].params[k]));q.param_name=l+"-"+q.param_name;_.isUndefined(p)||(q.param_name+="-"+p);a+=tdcSidebarPanel._bindParamAndGetHtml(q,
...
var l="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(l='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+l+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="hidden" value="'+
...
c.info_img+'"');if("tdb_mobile_menu"===b.get("tag")&&"menu_id"===c.param_name){var e=b.get("attrs");e.menu_id=window.tdcPostSettings.mobileMenuId;b.set("attrs",e)}var h=!1,g=!1;_.has(c,"tdc_dropdown_images")&&""!==c.tdc_dropdown_images&&(h=!0);_.has(c,"tdc_dropdown_texts")&&""!==c.tdc_dropdown_texts&&(g=!0);var l="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(l='data-enable-params="'+c.toggle_enable_params+'"');var f="";_.has(c,"toggle_disable_params")&&""!==c.toggle_disable_params&&
(f='data-disable-params="'+c.toggle_disable_params+'"');var k="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var m="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');var p="";_.has(c,"toggle_disabled_by")&&""!==c.toggle_disabled_by&&(p='data-disabled-by="'+c.toggle_disabled_by+'"');var q=e="",r=!1,t=Object.keys(c.value),v=!0;if(_.has(c,"tdc_min_options")&&t.length<=parseInt(c.tdc_min_options))return e;
for(var u=0;u<t.length;u++){var x=!1,B="",z="",w="",y="",A="",C=t[u],E=String(tdcSidebarPanel._getParameterCurrentValue(c,b)),D=String(c.value[t[u]]);_.has(c,"options_to_disable")&&""!==c.options_to_disable&&(z=c.options_to_disable);_.has(c,"options_to_hide")&&""!==c.options_to_hide&&(w=c.options_to_hide);_.isObject(c.value[t[u]])&&(x=!0,D=_.values(c.value[t[u]])[0],C=_.keys(c.value[t[u]])[0]);if(h||g)0===u&&""===E&&(E=D),E===D&&(B=" checked "),z=_.uniqueId(),w=D,"vc_row"!==b.attributes.tag&&"vc_row_inner"!==
b.attributes.tag||-1!==c.param_name.indexOf("flex_")||(w="col_"+w),q+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(c,b)+' id="'+z+'" name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+B+' value="'+D+'">',h?(B="",x&&(B="tdc-standard-value"),q+='<label class="tdc-property-input-radio-label '+B+'" for="'+z+'" title="'+C+'"><div class="'+w+'"></div></label>'):q+='<label class="tdc-property-input-radio-label" for="'+z+'" title="'+C+'">'+D+"</label>";else{E===
D&&(B=' selected="selected" ',v=!1);if("__"===D&&-1!==C.search("--")||-1<z.indexOf(D)&&""!==D)y=" disabled ";-1<w.indexOf(D)&&""!==D&&(A=' style="display:none" ',"popular"===D&&(A=""));""!==y&&""!==B&&(r=!0);q+="<option "+B+" "+y+A+' value="'+D+'">'+C+"</option>"}}t="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':t=' title="'+c.description+'" ');e+='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+l+" "+f+" "+k+" "+m+" "+p+">";e+=
'<div class="tdc-property-title"><span class="tdc-search-data"'+t+">"+c.heading+"</span>";d="";a="#";"tdb_flex_block_builder"!==b.get("tag")&&"tdb_flex_loop_builder"!==b.get("tag")||"cloud_tpl_module_id"!==c.param_name||(d="tdc-edit-cloud_tpl_module_id",l='style="margin-left: 10px"',_.has(b.get("attrs"),"cloud_tpl_module_id")?""===b.get("attrs").cloud_tpl_module_id.trim()?l='style="margin-left: 10px; display: none"':"undefined"!==typeof window.tdData&&(a=tdData.adminUrl+"post.php?post_id="+b.get("attrs").cloud_tpl_module_id.trim()+
"&td_action=tdc&tdbTemplateType=module"):l='style="margin-left: 10px; display: none"',e+='<a href="'+a+'" class="'+d+'" target="_blank" '+l+">Edit</a>","dev"===window.td_deploy_mode&&(e+='<a href="#" class="tdc-refresh-cloud_tpl_module" target="_blank" style="margin-left: 10px">Refresh list</a>'));e+='</div><div class="tdc-property">';h||g?e+=q:(r&&(d+=" selected-op-disabled"),v&&["tds_plans_button","tds_plans_price"].includes(b.get("tag"))&&(h=String(tdcSidebarPanel._getParameterCurrentValue(c,b)),
...
!0===c.responsive_disable_default&&(k=' data-responsive-disable-default="1"');var m="",p="",q=Object.keys(c.value);if(_.has(c,"tdc_min_options")&&q.length<=parseInt(c.tdc_min_options))return m;var r=' data-responsive="" ',t=String(tdcSidebarPanel._getParameterCurrentValue(c,b));try{var v=JSON.parse(window.atob(t));r=' data-responsive="'+t+'" ';"undefined"!==typeof v[tdcSidebar.currentViewportSettings.name]&&(t=v[tdcSidebar.currentViewportSettings.name])}catch(A){}for(v=0;v<q.length;v++){var u=!1,
x="",B="",z=q[v],w=String(c.value[q[v]]);_.isObject(c.value[q[v]])&&(u=!0,w=_.values(c.value[q[v]])[0],z=_.keys(c.value[q[v]])[0]);if(e||h){0===v&&""===t&&(t=w);t===w&&(x=" checked ");B=_.uniqueId();var y=w;"vc_row"!==b.attributes.tag&&"vc_row_inner"!==b.attributes.tag||-1!==c.param_name.indexOf("flex_")||(y="col_"+y);p+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(c,b)+' id="'+B+'" name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+x+' value="'+w+
'" '+r+">";e?(x="",u&&(x="tdc-standard-value"),p+='<label class="tdc-property-input-radio-label '+x+'" for="'+B+'" title="'+z+'"><div class="'+y+'"></div></label>'):p+='<label class="tdc-property-input-radio-label" for="'+B+'" title="'+z+'">'+w+"</label>"}else t===w&&(x=' selected="selected" '),"__"===w.substring(0,2)&&-1!==z.search("--")&&(B=" disabled "),p+="<option "+x+" "+B+' value="'+w+'">'+z+"</option>"}q="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+
'"':q=' title="'+c.description+'" ');m+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+g+" "+l+" "+f+k+">";m+='<div class="tdc-property-title"><span class="tdc-search-data"'+q+">"+c.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';m+='<div class="tdc-property">';e||h?m+=p:(m+="<select "+tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+
'" '+r+q+">",m=m+p+"</select>");m=m+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return m+"</div>"},addCheckBox:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="",g=tdcSidebarPanel._getParameterCurrentValue(c,b);"product_cat_type_action"===c.param_name?""!==g&&"single_selection"!==g&&(h=
" checked "):""!==g&&(h=" checked ");var l="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(l='data-enable-params="'+c.toggle_enable_params+'"');var f="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(f='data-enable-params-reverse="1"');var k="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(k='data-enabled-by="'+c.toggle_enabled_by+'"');var m="";_.has(c,"toggle_disabled_by")&&""!==c.toggle_disabled_by&&(m='data-disabled-by="'+c.toggle_disabled_by+
'"');g="";var p=tdcSidebarPanel._getParameterClasses(c);if(p.includes("tdc-filter-multiple")||p.includes("tdc-filter-single"))g=' title="'+c.description+'" ';d='<div class="'+p+'" '+d+" "+a+" "+l+" "+f+" "+k+" "+m+'><div class="tdc-property-title"><span class="tdc-search-data"'+(e+">"+c.heading+"</span></div>");d=d+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="checkbox" value="yes" '+h+" "+g+"/>");d=d+'</div><span class="tdc-param-name">'+
(c.param_name+"</span>");return d+"</div>"},addCheckBoxResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="",h=' data-responsive="" ',g=String(tdcSidebarPanel._getParameterCurrentValue(c,b));try{var l=JSON.parse(window.atob(g));h=' data-responsive="'+g+'" ';"undefined"!==typeof l[tdcSidebar.currentViewportSettings.name]&&(g=l[tdcSidebar.currentViewportSettings.name])}catch(m){}""!==g&&(e=" checked ");l="";_.has(c,"description")&&
...
""!==c.toggle_enabled_by&&(l='data-enabled-by="'+c.toggle_enabled_by+'"');var f=c.tdc_values,k=tdcSidebarPanel._getParameterCurrentValue(c,b),m="",p="",q=[],r="",t="",v="",u="",x="",B="",z="",w;for(w in f)f.hasOwnProperty(w)&&(q.push(f[w].unit),""===t||""===r)&&(u=f[w].unit,t=' data-range_unit="'+u+'" ',v=f[w].value,r=' data-range_value="'+v+'" ',x=f[w].range_min,B=f[w].range_max,z=f[w].range_step);if(""!==k){for(var y=[],A=0;A<q.length&&!(y=k.split(q[A]),1<y.length);A++);y.length&&(u=q[A],t=' data-range_unit="'+
u+'" ',v=y[0],r=' data-range_value="'+v+'" ')}for(w in f)f.hasOwnProperty(w)&&(k=_.uniqueId(),m+=" data-value_"+w+'="'+f[w].value+'" ',m+=" data-min_"+w+'="'+f[w].range_min+'" ',m+=" data-max_"+w+'="'+f[w].range_max+'" ',m+=" data-step_"+w+'="'+f[w].range_step+'" ',q=f[w].value,y="",f[w].unit===u&&(q=v,x=f[w].range_min,B=f[w].range_max,z=f[w].range_step,y="checked"),p+='<input name="'+tdcSidebarPanel._getParameterDomName(c)+'_unit" data-unit="'+w+'" data-unit_value="'+f[w].unit+'" type="radio" id="'+
k+'" '+y+' data-default_value="'+f[w].value+'" data-last_value="'+q+'"/>',p+='<label for="'+k+'">'+f[w].unit+"</label>");d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+l+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" '+r+" "+t+" "+
m+' min="'+x+'" max="'+B+'" step="'+z+'" value="'+v+'"/>');d=d+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+p+'</div><input type="text" class="tdc_range_value" value="'+(v+'"/>');d+="</div>";d+="</div>";d+='<span class="tdc-param-name">'+c.param_name+"</span>";return d+="</div>"},addRangeMultipleResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==
...
b),m="",p="",q=[],r=' data-responsive="" ',t="",v="",u="",x="",B="",z="",w="",y;for(y in f)f.hasOwnProperty(y)&&(q.push(f[y].unit),""===v||""===t)&&(x=f[y].unit,v=' data-range_unit="'+x+'" ',u=f[y].value,t=' data-range_value="'+u+'" ',B=f[y].range_min,z=f[y].range_max,w=f[y].range_step);if(""!==k){var A=k;try{var C=JSON.parse(window.atob(k));r=' data-responsive="'+k+'" ';A="undefined"===typeof C[tdcSidebar.currentViewportSettings.name]?"":C[tdcSidebar.currentViewportSettings.name]}catch(E){}if(""!==
A){k=[];for(C=0;C<q.length&&!(k=A.split(q[C]),1<k.length);C++);k.length&&(x=q[C],v=' data-range_unit="'+x+'" ',u=k[0],t=' data-range_value="'+u+'" ')}}for(y in f)f.hasOwnProperty(y)&&(q=_.uniqueId(),m+=" data-value_"+y+'="'+f[y].value+'" ',m+=" data-min_"+y+'="'+f[y].range_min+'" ',m+=" data-max_"+y+'="'+f[y].range_max+'" ',m+=" data-step_"+y+'="'+f[y].range_step+'" ',A=f[y].value,k="",f[y].unit===x&&(A=u,B=f[y].range_min,z=f[y].range_max,w=f[y].range_step,k="checked"),p+='<input name="'+tdcSidebarPanel._getParameterDomName(c)+
'_unit" data-unit="'+y+'" data-unit_value="'+f[y].unit+'" type="radio" id="'+q+'" '+k+' data-default_value="'+f[y].value+'" data-last_value="'+A+'"/>',p+='<label for="'+q+'">'+f[y].unit+"</label>");d='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+l+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(c,
b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" '+t+" "+v+" "+m+" "+r+' min="'+B+'" max="'+z+'" step="'+w+'" value="'+u+'"/>');d=d+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+p+'</div><input type="text" class="tdc_range_value" value="'+(u+'"/>');d+="</div>";d+="</div>";d+='<span class="tdc-param-name">'+c.param_name+"</span>";return d+="</div>"},addIconSelector:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+
...
c.placeholder+'" ');var n="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(n='data-enable-params="'+c.toggle_enable_params+'"');var k="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var m="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+n+" "+k+" "+m+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+
...
'"');var k="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var m="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+n+" "+k+" "+m+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+h+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><textarea id="'+(e+'" class="tdc-textarea" '+
...
tdcSidebarController.onUpdate(b,c,"",a)});g.setTheme("ace/theme/textmate");g.getSession().setMode("ace/mode/html");g.setOptions({enableBasicAutocompletion:!0,enableSnippets:!0,wrap:!0,indentedSoftWrap:!1,fontSize:11});var h=jQuery("#tdc-ace-editor"),f=jQuery(".tdc-property-textarea_raw_html_ace .tdc-raw-html-ace"),l=h.children(".content");jQuery("body").on("click",".tdc-html-ace-editor-expand-collapse",function(){jQuery(".tdc-property-textarea_raw_html_ace .tdc-property-editor_expand").addClass("disabled");
h.find("header .title").text("HTML Code Editor");h.addClass("tdc-html-ace-editor-expand");l.empty();l.append(jQuery("#"+e+"_ace_html"));h.show();tdcWindowFrame.setWindowFrame(h);g.resize();setTimeout(function(){g.focus()},100)}).on("click",".tdc-html-ace-editor-expand .close",function(){h.removeClass("tdc-html-ace-editor-expand");h.hide();f.append(jQuery("#"+e+"_ace_html"));jQuery(".tdc-property-textarea_raw_html_ace .tdc-property-editor_expand").removeClass("disabled");tdcWindowFrame.unsetWindowFrame(h);
...
d.length&&(g=d.find(".tdb-template-el-mobile:first"),d.find(".tdb-template-el-mobile-btns:first").data("mobile-template-id",a.mobile_template_id),g.html('<span class="tdb-template-el-mobile-active">Yes</span>')),!c.isUndefined(tdcAdminIFrameUI._liveIframeWindowObject.tdbGetMobileTemplates))){var l;f("#tdb-mobile-templates").length&&(l=document);tdcAdminIFrameUI._liveIframeWindowObject.tdbGetMobileTemplates("header",h,b,b,b,l,a.mobile_template_id)}},error:function(a,b,c){}})},htmlInfoContent:'Enter the mobile template name: <input id="tdb-new-template-name" type="text" value=""onfocus="(function(e){ jQuery( e.target ).siblings(\'#tdb-modal-notice\').fadeOut(50); })(event)"/><em id="tdb-modal-notice"></em><div class="tdb-form-check"><input type="checkbox" class="form-check-input" id="tdb-copy-content"><label class="form-check-label" for="tdb-copy-content"><span class="tdb-check"></span><span class="tdb-check-title">Copy content</span></label></div>',
...
a="";e=tdcTemplateSettingsPanel.$panel.find(".tdc-tsc-viewport-width");var k=e.find('[data-viewport="'+g+'"]'),m="";switch(g){case "all":a="Desktop";break;case "landscape":a="Landscape tablet";break;case "portrait":a="Portrait tablet";break;case "phone":a="Phone"}e.find(".tdc-tsc-label span").text("("+a+")");e.find('[id*="tdc-tsc-viewport"]').hide();k.show();"all"===g?m=""!==k.val()?k.val():"100%":""!==k.val()?m=k.val():(g=e.find('[data-viewport="all"]'),m=""!==g.val()?g.val():"100%");h.contents().find("body").css("width",
m)}setTimeout(function(){tdcIFrameData.addDummyContent();var a=h.contents().find(".td_block_wrap");window.checkTdBlockWrap(a)},100);document.dispatchEvent(new CustomEvent("tdc.viewportChanged",{detail:{oldViewport:d,currentViewport:tdcSidebar.currentViewportSettings.name}}))});f("body").on("change, keyup",'.tdc-search input[type="text"]',function(b){b=f(this);var a=f(".tdc-inspector"),d=a.find(".tdc-tab-content-wrap");a.find(".tdc-search-notice").remove();a.find(".tdc-tab-search-notice").hide();var h=
...
l=b.find(".tdc-css-box-input-margin-left").val().trim(),n=b.find(".tdc-css-box-input-border-top-width").val().trim(),k=b.find(".tdc-css-box-input-border-right-width").val().trim(),m=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),p=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),r=b.find(".tdc-css-box-input-padding-right").val().trim(),t=b.find(".tdc-css-box-input-padding-bottom").val().trim(),v=b.find(".tdc-css-box-input-padding-left").val().trim(),
u=b.find(".tdc-css-border-radius").val().trim(),x=b.find(".tdc-css-width").val().trim(),B=b.find(".tdc-css-height").val().trim(),z=b.find(".tdc-css-shadow-size").val().trim(),w=b.find(".tdc-css-shadow-offset-h").val().trim(),y=b.find(".tdc-css-shadow-offset-v").val().trim(),A=b.find(".tdc-css-opacity").val().trim(),C=b.find(".tdc-css-gradient-direction").val().trim(),E=b.find(".tdc-css-z-index").val().trim(),D="";b.find(".tdc-css-order").length&&(D=b.find(".tdc-css-order").val().trim());""!==d&&(a["margin-top"]=
d);""!==f&&(a["margin-right"]=f);""!==g&&(a["margin-bottom"]=g);""!==l&&(a["margin-left"]=l);""!==n&&(a["border-top-width"]=n);""!==k&&(a["border-right-width"]=k);""!==m&&(a["border-bottom-width"]=m);""!==p&&(a["border-left-width"]=p);""!==q&&(a["padding-top"]=q);""!==r&&(a["padding-right"]=r);""!==t&&(a["padding-bottom"]=t);""!==v&&(a["padding-left"]=v);d=b.find(".tdc-css-border-style");f=d.val().trim();""===f||d.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=
f);d=b.find(".tdc-css-border-color");f=d.val().trim();""!==f?a["border-color"]=f:(d=d.data("no_value"),c.isUndefined(d)||1!==d||(a["border-color"]="no_value"));""!==u&&(a["border-radius"]=u);""!==x&&(a.width=x);""!==B&&(a.height=B);""!==z&&(a["shadow-size"]=z);u=b.find(".tdc-css-shadow-color");x=u.val().trim();""!==x?a["shadow-color"]=x:(u=u.data("no_value"),c.isUndefined(u)||1!==u||(a["shadow-color"]="no_value"));""!==w&&(a["shadow-offset-h"]=w);""!==y&&(a["shadow-offset-v"]=y);w=b.find(".tdc-css-bg-color");
...
"";"undefined"!==typeof a.mixedColors[q].percentage&&(r=a.mixedColors[q].percentage+"%");"undefined"!==typeof a.mixedColors[q].color&&(p+=a.mixedColors[q].color+" "+r+",")}b+="background: "+h[m]+"("+c+a.color2+","+p+a.color1+");";e+="background: "+h[m]+"( -90deg,"+a.color2+","+p+a.color1+");"}c=c+a.color2+","+p+a.color1;a.result={type:"gradient",color1:a.color1,color2:a.color2,mixedColors:a.mixedColors,degree:a.degree,css:b,cssParams:c};a.$gradientResult.attr("style",e)}else if("undefined"!==typeof a.color1||
...
a?a:"")},create:function(){var c=parseFloat(h.alpha/100);m.text(1>c?c:"");p.css("background-color",h.value);l.on("click",".wp-picker-clear",function(){e._color._alpha=1;m.text("");k.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(d,!0):a.setColor(d)});l.on("click",".wp-picker-default",function(){var a=f.cs_ParseColorValue(b.data("default-color")),c=parseFloat(a.alpha/100);e._color._alpha=c;m.text(1>c?c:"");k.slider("option","value",a.alpha).trigger("slide")});l.on("click",
...
break;case "single":case "cpt":b=window.tdcPostSettings.tdbTemplateType;var h="",g=e=a=c="",l="undefined"!==typeof window.tdcPostSettings.tdbTemplateSettings.autoload_options?Object.entries(window.tdcPostSettings.tdbTemplateSettings.autoload_options):Object.entries(window.tdb_p_autoload_vars);l=$jscomp.makeIterator(l);for(var n=l.next();!n.done;n=l.next()){var k=$jscomp.makeIterator(n.value);n=k.next().value;k=k.next().value;switch(n){case "status":c=k;"on"===c&&(a='checked="checked"');break;case "type":h=
k;break;case "count":e=k;break;case "scroll_percent":g=k}}l=[{name:"Latest posts",value:"latest_posts"},{name:"Previous posts",value:"prev"},{name:"Next posts",value:"next"}];n="";switch(b){case "single":l.push({name:"Same category previous",value:"same_cat_prev"},{name:"Same category next",value:"same_cat_next"},{name:"Same category latest",value:"same_cat_latest"},{name:"Post autoload tag",value:"post_autoload_tag"});n+='<div class="tdc-tsc-notif tdc-tsc-notif-autoload-tag tdc-tsc-notif-warning" style="display: none;">Please note that this option may not return accurate results if you don\'t set the <b>Autoload tag</b> option using a preferred tag slug for each individual post that uses this single template.</div>';
break;case "cpt":l.push({name:"Same taxonomy terms previous",value:"same_tax_prev"},{name:"Same taxonomy terms next",value:"same_tax_next"},{name:"Same taxonomy terms latest",value:"same_tax_latest"}),n+='<div class="tdc-tsc-notif tdc-tsc-notif-autoload-tax-latest tdc-tsc-notif-warning" style="display: none;">Please note that this option will refer to all taxonomies terms found on post. <br><br> To relate just on one of post\'s taxonomies terms you can use the <b>Autoload taxonomy</b> option for each individual post that uses this cpt template.</div><div class="tdc-tsc-notif tdc-tsc-notif-autoload-tax-next-prev tdc-tsc-notif-warning" style="display: none;">Please note that this option will auto select a taxonomy and load next/prev posts based on the terms set on post from the auto selected taxonomy. <br><br> To focus on one specific post taxonoy you can use the <b>Autoload taxonomy</b> option for each individual post that uses this cpt template.</div>'}var m=
"";l.forEach(function(a,b,c){m+='<option value="'+a.value+'" '+(h===a.value?"selected":"")+">"+a.name+"</option>"});tdcTemplateSettingsPanel.$panel.find(".tdc-ts-c-body").append('<div class="tdc-ts-cb-section"><div class="tdc-tsc-section-title">Articles auto loading</div><label class="tdc-tsc-switch"><input type="checkbox" value="'+c+'" class="tdc-tsc-switch-input" id="tdc-tsc-autoload-status" '+a+'><div class="tdc-tsc-switch-btn"><div class="tdc-tsc-switch-ball"></div></div><div class="tdc-tsc-switch-label" title="Enable or disable the articles auto loading.">Enable auto loading</div></label><div class="tdc-tsc-select-wrap"><div class="tdc-tsc-label">Auto loading type</div><select class="tdc-tsc-input tdc-tsc-autoload-type-select" id="tdc-tsc-autoload-type"><option value="">- Select type -</option>'+
m+"</select>"+n+'</div><div class="tdc-tsc-input-wrap tdc-tsc-autoload-art-count"><div class="tdc-tsc-label">Limit articles number</div><input type="number" name="tdc-tsc-autoload-art-count" id="tdc-tsc-autoload-art-count" class="tdc-tsc-input" placeholder="5" min="1" value="'+e+'" pattern="[0-9]"/></div><div class="tdc-tsc-input-wrap tdc-tsc-autoload-scroll-percent"><div class="tdc-tsc-label">Page scroll percent</div><input type="number" name="tdc-tsc-autoload-scroll-percent" id="tdc-tsc-autoload-scroll-percent" class="tdc-tsc-input" placeholder="50" min="0" value="'+
