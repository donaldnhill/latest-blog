                    ...
                    if ( 'module' === $tdbTemplateType ) {
	                    ...
	                    if ( !empty( $multipurpose_mapped_shortcodes ) ) {
		                    ...
		                    foreach ( $multipurpose_mapped_shortcodes as $mapped_shortcode ) {
								...
								if ( in_array( $mapped_shortcode['base'], array('tdm_block_button', 'tdm_block_column_title', 'tdm_block_column_title_simplified', 'tdm_block_inline_text', 'tdm_block_inline_text_simplified', 'tdm_block_icon', 'tdm_block_inline_image') ) ) {
									continue;
								}
