        ...
        if ( !empty( $taxonomies ) && is_array( $taxonomies ) ) {
            ...
            foreach ( $taxonomies as $taxonomy ) {
	            ...
	            $settings[] = array(
		            ...
		            "holder"      => "div",
		            "class"       => "tdc-filter-controller tdc-filter-type tdc-woo-filter-type",
		            "group"       => "",
	            );
	            ...
	            if ( isset( $taxonomy->attribute_id ) ) { // is attribute tax
                    ...
                    $settings[] = array(
                        "param_name"  => strtolower( $tax_name ) . "_single_selection",
                        "type"        => "checkbox",
                        "value"       => 'no',
...
checked > Multiple selection - filter products from multiple attributes based on selection.",
                        "holder"      => "div",
                        "class"       => "tdc-filter-controller tdc-filter-single tdc-woo-filter-single",
                        "group"       => "",
                        "toggle_enable_params" => strtolower( $tax_name ) . "_single_selection",
                    );
		            ...
		            $settings[] = array(
			            ...
			            "value"       => '',
			            "heading"     => 'Enable multiple selection on ' . $tax_label,
			            "description" => "unchecked > AND: Only products that have every selected attribute will be included in the results.
checked > OR: Products that contain any of the selected attributes will be included in the results.",
			            "holder"      => "div",
			            "class"       => "tdc-filter-controller tdc-filter-multiple tdc-woo-filter-multiple",
			            "group"       => "",
                        "toggle_enabled_by" => strtolower( $tax_name ) . "_single_selection",
                    );
